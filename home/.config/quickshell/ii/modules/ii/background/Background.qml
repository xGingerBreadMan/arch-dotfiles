    ...
    PanelWindow {
        ...
        Item {
            ...
            StyledImage {
                ...
                // StyledImage retains the previous texture while loading. Keep it
                // visible so an older wallpaper underneath cannot flash through.
                opacity: (!bgRoot.wallpaperIsVideo && !bgRoot.wallpaperSafetyTriggered) ? 1 : 0
